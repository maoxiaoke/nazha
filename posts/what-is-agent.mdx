...
![](https://assets.nazha.co/compents-of-llms-based-agent.png)
...
![](https://assets.nazha.co/agent-in-action.png)
...
![](https://assets.nazha.co/plan-and-execute-agent.png)
...
![](https://assets.nazha.co/how-clline-work-more-detail.png)
...
![](https://assets.nazha.co/meta_ai_screenshot.png)
...
![](https://assets.nazha.co/workflow-based-prompt-chaing.png)
