---
title: My New Macbook Setup (2022)
published: true
listed: true
date: '05/26/2022'
...
![](https://nazha-image-store.oss-cn-shanghai.aliyuncs.com/blog/enable-tap-to-click.png)
...
![](https://nazha-image-store.oss-cn-shanghai.aliyuncs.com/blog/enable-three-finger-drag.png)
...
![](https://nazha-image-store.oss-cn-shanghai.aliyuncs.com/blog/chrome-eats-battery.png)
...
![](https://nazha-image-store.oss-cn-shanghai.aliyuncs.com/blog/iterm2-blur.png)

+ Go 「**iterm2 Preferences -> Profiles -> Default -> Keys -> Key Mappings**」, replace the standard ones with the preset "Natural Text Editing".

![](https://nazha-image-store.oss-cn-shanghai.aliyuncs.com/blog/iterm2-natural-text-editing.png)
...
![](https://nazha-image-store.oss-cn-shanghai.aliyuncs.com/blog/honukai-theme.png)
...
![](https://nazha-image-store.oss-cn-shanghai.aliyuncs.com/blog/git-plugin.png)
...
![](https://nazha-image-store.oss-cn-shanghai.aliyuncs.com/blog/diable-spotlight-shortcut.png)

Open the Alfred settings and use the freed up `⌘ Space` combination to launch Alfred.

![](https://nazha-image-store.oss-cn-shanghai.aliyuncs.com/blog/update-alfred-shortcut.png)
...
![](https://nazha-image-store.oss-cn-shanghai.aliyuncs.com/blog/clipboard-history-shortcut.png)
...
![](https://nazha-image-store.oss-cn-shanghai.aliyuncs.com/blog/vscode-editing.png)
...
![](https://nazha-image-store.oss-cn-shanghai.aliyuncs.com/blog/vscode-code-command.png)
