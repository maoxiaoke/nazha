...
export default function Tweet({
  ...
  return (
    <div className="tweet m-auto sm:w-3/4 rounded-lg border border-gray-200 dark:border-gray-800 px-6 py-4 my-10 w-full bg-white dark:bg-gray-900">
      <div className="flex items-center">
        ...
        <a className="ml-auto" href={authorUrl} target="_blank" rel="noopener noreferrer" aria-label={`View ${author.name} on Twitter`}>
          <svg viewBox="328 355 335 276" height="24" width="24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <path
      ...
      <div className="flex !text-gray-700 dark:!text-gray-300 mt-2">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer">
          <svg className="mr-2" width="24" height="24" viewBox="0 0 24 24" aria-hidden="true">
            <path
          ...
          <span>
            {Number(public_metrics.reply_count).toLocaleString('en', { notation: 'compact' })}
          </span>
        </a>
        <a
          ...
          <span>
            {Number(public_metrics.retweet_count).toLocaleString('en', { notation: 'compact' })}
          </span>
        </a>
        <a
          ...
          <span>
            {Number(public_metrics.like_count).toLocaleString('en', { notation: 'compact' })}
          </span>
        </a>
      </div>
    </div>
