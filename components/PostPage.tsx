  ...
  return (
    <>
      <NextSeo
        ...
        canonical={`https://nazha.vercel.app/posts/${meta.slug}`}
        openGraph={{ url: `https://nazha.vercel.app/posts/${meta.slug}` }}
        additionalMetaTags={[
      ...
      <article className="max-w-[85ch] mx-auto pt-12 pb-28 px-5 prose dark:prose-invert">
        <div>
